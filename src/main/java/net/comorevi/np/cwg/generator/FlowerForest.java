...
public class FlowerForest extends Generator {
    ...
    public FlowerForest(Map<String, Object> options) {
        //Nothing here. Just used for future update.
    }

    @Override
    public int getId() {
        return Main.GENERATE_TYPE_FLOWER_FOREST;
    }
    ...
    public Biome pickBiome() {
        return EnumBiome.FLOWER_FOREST.biome;
    }
